...
interface InputSelectProps {
  ...
  bikeId?: string; // ID da bicicleta selecionada (opcional)
  onBikeChange?: (bikeId: string) => void; // Função para lidar com a mudança da bicicleta (opcional)
}
...
const InputSelect: React.FC<InputSelectProps> = ({
  ...
  const handleSelectChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    // Chame a função de mudança da bicicleta, se existir
    if (onBikeChange) {
